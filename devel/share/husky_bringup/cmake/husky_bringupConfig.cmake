...
if("TRUE" STREQUAL "TRUE")
  set(husky_bringup_SOURCE_PREFIX /home/testacc/husky_robot/src/husky_bringup)
  set(husky_bringup_DEVEL_PREFIX /home/testacc/husky_robot/devel)
  ...
  set(husky_bringup_INSTALL_PREFIX /home/testacc/husky_robot/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'husky_bringup' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Paul Bovbel <pbovbel@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'husky_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/testacc/husky_robot/src/husky_bringup/${idir}'.  Ask the maintainer 'Paul Bovbel <pbovbel@clearpathrobotics.com>' to fix it.")
    endif()
